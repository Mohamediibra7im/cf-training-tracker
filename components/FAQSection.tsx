...
const faqs: FAQ[] = [
  {
    ...
    answer: 'To create an account, enter your Codeforces handle on the homepage and create a 4-digit PIN. The system will automatically fetch your profile data from Codeforces and create your account.',
    category: 'Account',
  ...
  {
    id: '2',
    question: 'Why can I not log in with my correct handle and PIN?',
    answer: 'Make sure your Codeforces handle is entered exactly as it appears on Codeforces (case-sensitive). Also verify that your PIN is correct. If the issue persists, try clearing your browser cache or use the PIN reset feature.',
  ...
  },
  {
    ...
    answer: 'Go to your profile settings, click "Change PIN", enter your current PIN, then enter and confirm your new 4-digit PIN. Make sure to remember your new PIN as it is required for future logins.',
    category: 'Account',
    tags: ['pin', 'security', 'settings'],
    popular: false,
  },
  {
    id: '8',
